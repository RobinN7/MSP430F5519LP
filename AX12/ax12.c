...
void SetTX() {
    PMAPKEYID = 0x02D52;                 // Authorize access to the port mapping registers
    
    P4MAP3 = 12;                        // Remap P4.3 to PM_UCA1TXD
    
    PMAPKEYID = 0x96A5;                 // Prevent access to the port mapping registers
}
...
void SetRX() {
    ...
    P4MAP4 = 11;                        // Remap P4.3 to PM_UCA1RXD
